...
public class UserAccount extends Model {
	...
	public static Finder<Long, UserAccount> find = new Finder(Long.class,
			UserAccount.class);
	...
	public static UserAccount authenticateMail(String email, String password) {
		return find.where().eq("mail", email).eq("password", password)
				.findUnique();
	}
	 ...
	 * Authenticate a User.
	 */
	public static UserAccount authenticateNickname(String nickname,
			String password) {
		return find.where().eq("nickname", nickname).eq("password", password)
				.findUnique();
	}
